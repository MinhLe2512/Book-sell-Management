...
namespace BTL.KetNoiMySQL
{
    public class controlAdmin
    {
        public void Insert(string adminName, int gioiTinh, string image, string password, string address,string phone,string email,string acc)
        {
            ...
            if (gioiTinh == 1)
            {
                sqlCom = new MySqlCommand("insert into users values(@name,1,@image,@password,@address,@phone,@email,@acc,null,1)");
            }
            else
            {
                sqlCom = new MySqlCommand("insert into users values(@name,0,@image,@password,@address,@phone,@email,@acc,null,1)");
            }
