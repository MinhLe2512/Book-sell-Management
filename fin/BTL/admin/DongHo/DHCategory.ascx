...
<div class="titile_watchs">Danh Sách Các Loại Sản phẩm</div>
    ...
    <asp:View ID="v2" runat="server">
        ...
        <table  id="tblEditDH">
            <tr class="tr_tblAddNew">
                <td class="td_CateDH_title_addNew" style=" width: 120px;">Loại Sản Phẩm:</td>
            ...
            <tr class="tr_tblAddNew">
                <td class="td_CateDH_title_addNew" style=" width: 120px;">Mô tả:</td>
                 <td>
