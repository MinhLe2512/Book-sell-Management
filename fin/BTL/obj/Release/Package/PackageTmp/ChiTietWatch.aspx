   ...
   <div class="wrapper" id="WrapDetailWatch"  style="width:92vw;max-width: 1257px;margin: 0 auto;">
    <div class="container">
        ...
        <div class="ctdh1">
			...
			<div class="ctdh2">
				...
				<div class="content_head fl-left">
					...
					<p></p>
					<div class="tskt" >
						<div class="fl-left tskt1">Rating:</div>
					...
					<div class="tskt tskt2">
						<div class="fl-left tskt1">Chất liệu:</div>
				...
				<div class=" fl-right menu_Choose_right" hidden>
					<div><b>Chọn cửa hàng gần bạn nhất</b></div>
					<div >
		...
		<div class="chiTiet">
			...
			<div class="chiTiet_content" hidden>
